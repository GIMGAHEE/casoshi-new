...
export const FURNITURE_CATALOG = [
  ...
  },
  {
    id: 'bed_ivory_leaf',
    label: 'アイボリーリーフ',
    image: '/furniture/bed_ivory_leaf.png',
    category: 'bed',
    aspectRatio: 0.816,
    defaultWidthPercent: 15.5,
  },
  {
    id: 'bed_princess',
    label: 'プリンセス',
    image: '/furniture/bed_princess.png',
    category: 'bed',
    aspectRatio: 0.745,
    defaultWidthPercent: 15.0,
  },
  {
    id: 'bed_green_rattan',
    label: 'グリーンラタン',
    image: '/furniture/bed_green_rattan.png',
    category: 'bed',
    aspectRatio: 0.734,
    defaultWidthPercent: 14.5,
  },
  {
    id: 'bed_pink_heart',
    label: 'ピンクハート',
    image: '/furniture/bed_pink_heart.png',
    category: 'bed',
    aspectRatio: 0.822,
    defaultWidthPercent: 16.0,
  },
  {
    id: 'bed_moon_star',
    label: 'ムーン＆スター',
    image: '/furniture/bed_moon_star.png',
    category: 'bed',
    aspectRatio: 0.770,
    defaultWidthPercent: 15.0,
  },
  {
    id: 'bed_canopy_pink',
    label: 'キャノピー',
    image: '/furniture/bed_canopy_pink.png',
    category: 'bed',
    aspectRatio: 0.806,
    defaultWidthPercent: 15.5,
  },
  {
    id: 'bed_purple_heart',
    label: 'パープルハート',
    image: '/furniture/bed_purple_heart.png',
    category: 'bed',
    aspectRatio: 0.773,
    defaultWidthPercent: 15.0,
  },
  {
    id: 'bed_royal_gold',
    label: 'ロイヤル',
    image: '/furniture/bed_royal_gold.png',
    category: 'bed',
    aspectRatio: 0.834,
    defaultWidthPercent: 16.5,
  },
  {
    id: 'wardrobe',
    label: 'クローゼット',
...
// ===== 가구 해금 시스템 =====
// 카테고리별로 2개씩 단계 해금.
// Lv.1 = 처음 2개 (스타터), Lv.5 = 다음 2개, Lv.10 = 다음 2개, Lv.15 = 다음 2개 ...
// 예) seat 가구 8개: index 0,1→Lv.1 / 2,3→Lv.5 / 4,5→Lv.10 / 6,7→Lv.15
...
// 특정 가구의 해금 레벨
// tier 0 (처음 2개) = Lv.1, tier 1 = Lv.5, tier 2 = Lv.10 ...
export const getFurnitureUnlockLevel = (furnitureId) => {
  const idx = _categoryIndexCache[furnitureId] ?? 0;
  const tier = Math.floor(idx / PER_LEVEL_PER_CATEGORY);
  return tier === 0 ? 1 : tier * LEVEL_STEP;
};
