...
export const HAIRSTYLES = [
  ...
  { id: 'boy_hair_brown_fluffy',     gender: 'boy', label: 'ふんわり',         overlay: '/sprites/boy_hair_brown_fluffy.png',     defaultTransform: { x: 0, y: -17, scale: 0.72 } },
  ...
  { id: 'boy_hair_black_short_spike',gender: 'boy', label: 'ショートスパイク', overlay: '/sprites/boy_hair_black_short_spike.png',defaultTransform: { x: 0, y: -18, scale: 0.64 } },
