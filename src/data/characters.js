...
export const HAIRSTYLES = [
  ...
  { id: 'hair_long_full',     gender: 'girl', label: 'ロング',     overlay: '/sprites/hair_long_full.png',     defaultTransform: { x: 0, y:  -5, scale: 0.88 } },
  { id: 'hair_long_bangs',    gender: 'girl', label: 'ロングバング', overlay: '/sprites/hair_long_bangs.png',    defaultTransform: { x: 0, y:  -2, scale: 0.90 } },
  { id: 'hair_medium_wavy',   gender: 'girl', label: 'ミディウェーブ', overlay: '/sprites/hair_medium_wavy.png',   defaultTransform: { x: 0, y:  -5, scale: 0.86 } },
  { id: 'hair_shoulder_wavy', gender: 'girl', label: 'セミロング', overlay: '/sprites/hair_shoulder_wavy.png', defaultTransform: { x: 0, y: -10, scale: 0.82 } },
  { id: 'hair_twin_bangs',    gender: 'girl', label: 'ツイン',     overlay: '/sprites/hair_twin_bangs.png',    defaultTransform: { x: 0, y: -10, scale: 0.84 } },
  { id: 'hair_side_pony',     gender: 'girl', label: 'サイドまとめ', overlay: '/sprites/hair_side_pony.png',     defaultTransform: { x: 0, y: -10, scale: 0.82 } },
  { id: 'hair_half_braid',    gender: 'girl', label: 'ハーフブレイド', overlay: '/sprites/hair_half_braid.png',    defaultTransform: { x: 0, y:  -2, scale: 0.90 } },
  { id: 'hair_high_pony',     gender: 'girl', label: 'ハイポニー', overlay: '/sprites/hair_high_pony.png',     defaultTransform: { x: 0, y:   0, scale: 0.92 } },
  { id: 'hair_side_braid',    gender: 'girl', label: 'サイドブレイド', overlay: '/sprites/hair_side_braid.png',    defaultTransform: { x: 0, y:   2, scale: 0.94 } },
  { id: 'hair_twin_braids',   gender: 'girl', label: 'ツインブレイド', overlay: '/sprites/hair_twin_braids.png',   defaultTransform: { x: 0, y:   0, scale: 0.92 } },
  // ===== 男の子 (boy) =====
