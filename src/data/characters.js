...
export const HAIRSTYLES = [
  ...
  // ===== 男の子 (boy) =====
  { id: 'boy_hair_brown_wavy',       gender: 'boy', label: 'ブラウンウェーブ', overlay: '/sprites/boy_hair_brown_wavy.png',       defaultTransform: { x: 0, y: -15, scale: 0.72 } },
  ...
  { id: 'boy_hair_brown_dark_bangs', gender: 'boy', label: '前髪ダーク',       overlay: '/sprites/boy_hair_brown_dark_bangs.png', defaultTransform: { x: 0, y: -13, scale: 0.72 } },
  ...
  { id: 'boy_hair_brown_mid',        gender: 'boy', label: 'ブラウンミディ',   overlay: '/sprites/boy_hair_brown_mid.png',        defaultTransform: { x: 0, y: -15, scale: 0.72 } },
