...
export const HAIRSTYLES = [
  ...
  // ===== 男の子 (boy) =====
  { id: 'boy_hair_brown_wavy',       gender: 'boy', label: 'ブラウンウェーブ', overlay: '/sprites/boy_hair_brown_wavy.png',       defaultTransform: { x: 0, y: -20, scale: 0.62 } },
  { id: 'boy_hair_black_voluminous', gender: 'boy', label: 'ボリューム',       overlay: '/sprites/boy_hair_black_voluminous.png', defaultTransform: { x: 0, y: -15, scale: 0.72 } },
  ...
  { id: 'boy_hair_brown_dark_bangs', gender: 'boy', label: '前髪ダーク',       overlay: '/sprites/boy_hair_brown_dark_bangs.png', defaultTransform: { x: 0, y: -20, scale: 0.65 } },
  { id: 'boy_hair_auburn_wavy',      gender: 'boy', label: 'オーバーン',       overlay: '/sprites/boy_hair_auburn_wavy.png',      defaultTransform: { x: 0, y: -15, scale: 0.72 } },
  ...
  { id: 'boy_hair_black_parted',     gender: 'boy', label: 'センター',         overlay: '/sprites/boy_hair_black_parted.png',     defaultTransform: { x: 0, y: -18, scale: 0.67 } },
  { id: 'boy_hair_black_short_spike',gender: 'boy', label: 'ショートスパイク', overlay: '/sprites/boy_hair_black_short_spike.png',defaultTransform: { x: 0, y: -15, scale: 0.72 } },
  ...
  { id: 'boy_hair_brown_mid',        gender: 'boy', label: 'ブラウンミディ',   overlay: '/sprites/boy_hair_brown_mid.png',        defaultTransform: { x: 0, y: -20, scale: 0.67 } },
  { id: 'boy_hair_silver',           gender: 'boy', label: 'シルバー',         overlay: '/sprites/boy_hair_silver.png',           defaultTransform: { x: 0, y: -15, scale: 0.72 } },
  { id: 'boy_hair_platinum',         gender: 'boy', label: 'プラチナ',         overlay: '/sprites/boy_hair_platinum.png',         defaultTransform: { x: 0, y: -15, scale: 0.72 } },
  { id: 'boy_hair_black_full',       gender: 'boy', label: 'フル',             overlay: '/sprites/boy_hair_black_full.png',       defaultTransform: { x: 0, y: -15, scale: 0.72 } },
  { id: 'boy_hair_brown_messy',      gender: 'boy', label: 'メッシー',         overlay: '/sprites/boy_hair_brown_messy.png',      defaultTransform: { x: 0, y: -15, scale: 0.72 } },
