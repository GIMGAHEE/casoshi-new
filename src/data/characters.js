...
export const HAIRSTYLES = [
  ...
  // ===== 男の子 (boy) =====
  { id: 'boy_hair_brown_wavy',       gender: 'boy', label: 'ブラウンウェーブ', overlay: '/sprites/boy_hair_brown_wavy.png',       defaultTransform: { x: 0, y: -28, scale: 0.50 } },
  ...
  { id: 'boy_hair_brown_fluffy',     gender: 'boy', label: 'ふんわり',         overlay: '/sprites/boy_hair_brown_fluffy.png',     defaultTransform: { x: 0, y: -14, scale: 0.83 } },
