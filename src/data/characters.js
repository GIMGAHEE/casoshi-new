...
export const HAIRSTYLES = [
  ...
  { id: 'hair_bun_fancy',     gender: 'girl', label: 'シニヨン',   overlay: '/sprites/hair_bun_fancy.png',     defaultTransform: { x: 0, y: -13, scale: 0.82 } },
  { id: 'hair_long_bangs',    gender: 'girl', label: 'ロングバング', overlay: '/sprites/hair_long_bangs.png',    defaultTransform: { x: 0, y:  -3, scale: 0.88 } },
  { id: 'hair_shoulder',      gender: 'girl', label: 'セミロング', overlay: '/sprites/hair_shoulder.png',      defaultTransform: { x: 0, y: -10, scale: 0.82 } },
  { id: 'hair_bob_straight',  gender: 'girl', label: 'ぱっつんボブ', overlay: '/sprites/hair_bob_straight.png',  defaultTransform: { x: 0, y: -15, scale: 0.76 } },
  { id: 'hair_medium_bangs',  gender: 'girl', label: 'ミディバング', overlay: '/sprites/hair_medium_bangs.png',  defaultTransform: { x: 0, y: -10, scale: 0.82 } },
  { id: 'hair_side_ponytail', gender: 'girl', label: 'サイドポニー', overlay: '/sprites/hair_side_ponytail.png', defaultTransform: { x: 0, y:  -8, scale: 0.85 } },
  { id: 'hair_braid',         gender: 'girl', label: '編み込み',   overlay: '/sprites/hair_braid.png',         defaultTransform: { x: 0, y: -13, scale: 0.82 } },
  { id: 'hair_long_center',   gender: 'girl', label: 'ストレート', overlay: '/sprites/hair_long_center.png',   defaultTransform: { x: 0, y:  -4, scale: 0.88 } },
  { id: 'hair_high_ponytail', gender: 'girl', label: 'ハイポニー', overlay: '/sprites/hair_high_ponytail.png', defaultTransform: { x: 0, y: -15, scale: 0.85 } },
  { id: 'hair_long_clip',     gender: 'girl', label: 'ヘアピン',   overlay: '/sprites/hair_long_clip.png',     defaultTransform: { x: 0, y:  -5, scale: 0.86 } },
  // ===== 男の子 (boy) =====
