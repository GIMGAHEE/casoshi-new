    ...
    <div className="max-w-md mx-auto px-4 py-4 pb-24">
      ...
      <section className="mt-3 rounded-2xl overflow-hidden shadow-md border-2 border-oshi-sub bg-white">
        ...
        >
          <IsometricRoom character={character} size={340}>
            {/* 캐릭터를 방 중앙 바닥에 서있게 배치 */}
            <foreignObject x="140" y="150" width="120" height="180">
              <div
              ...
              >
                <div style={{ width: 100, height: 132, overflow: 'visible' }}>
                  {character.sprite ? (
                    <PixelAvatar sprite={character.sprite} size={100} hairColor={character.hairColor} baseHairColor={character.baseHairColor} />
                  ) : character.isMyOshi ? (
                    <PixelAvatar
            ...
            {/* 캐릭터 그림자 (바닥 타원) */}
            <ellipse cx="200" cy="308" rx="32" ry="8" fill="rgba(0,0,0,0.18)" />
          </IsometricRoom>
      ...
      <section className="mt-4 card p-3">
        <div className="flex items-center gap-3">
          ...
          >
            {character.sprite ? (
              <PixelAvatar sprite={character.sprite} size={48} hairColor={character.hairColor} baseHairColor={character.baseHairColor} />
            ) : character.isMyOshi ? (
              <PixelAvatar
                selections={{ parts: character.parts, colors: character.colors }}
                size={44}
